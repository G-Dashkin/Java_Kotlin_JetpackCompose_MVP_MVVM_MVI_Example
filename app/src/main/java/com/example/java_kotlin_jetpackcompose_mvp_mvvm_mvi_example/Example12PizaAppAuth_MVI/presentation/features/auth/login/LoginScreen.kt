...
import com.example.java_kotlin_jetpackcompose_mvp_mvvm_mvi_example.Example12PizaAppAuth_MVI.core.ui.theme.height8
...
@Composable
fun LoginScreen(
    loginUiState: LoginContract.State,
    ...
    Column(
        ...
        DefaultFormTextField(
            ...
            isError = loginUiState.loginError,
        ...
        Spacer(modifier = Modifier.height(height24))
        TextLink(sentence = stringResource(id = R.string.not_member_register_here), onLinkClicked = onRegisterClick)
        Spacer(modifier = Modifier.height(height8))
        TextLink(sentence = stringResource(id = R.string.forgot_password_reset_here), onLinkClicked = onResetClick)
    }
}
